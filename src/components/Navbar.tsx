    ...
    <nav className="px-8 text-white bg-black md:px-16 lg:px-24">
      <div className="container flex items-center justify-between py-2">
        ...
        <a href="#home" className="flex items-center">
          ...
          />
          <span className="p-1 text-2xl font-bold rounded hover:bg-gradient-to-r from-green-300 to-blue-500">
            Edem
          </span>
        </a>
        ...
        <div className="hidden space-x-6 md:flex">
          <a
            href="#home"
            className="p-1 font-bold rounded hover:text-white hover:bg-gradient-to-r from-green-300 to-blue-500"
          >
            Home
          </a>
          <a
