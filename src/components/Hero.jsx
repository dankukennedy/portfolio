  ...
  return (
    <div className='bg-gradient-to-r from-red-200 to-red-500 text-white text-center py-16 '>
         ...
         <div className='mt-8 space-x-4 '>
          <a href="https://www.linkedin.com/in/kennedy-edem-danku-839108137" target='_blank' >
          <button className='bg-gradient-to-r from-green-400 to-blue-500 text-white md:inline transform transition-transform duration-300 hover:scale-105 px-4 py-2 rounded-full'>LinkedIn Profile</button>
          </a>
