...
const systems: ProjectItem[] = [
  {
    ...
    image: Employee,
    github: "https://employeemgt.vercel.app/login",
  },
  {
    id: 5,
...
function Card({ project, index }: { project: ProjectItem; index: number }) {
  ...
  return (
    <motion.a
      ...
      className="group relative rounded-2xl glass overflow-hidden hover:border-emerald-500/40 transition-colors flex flex-col"
    >
